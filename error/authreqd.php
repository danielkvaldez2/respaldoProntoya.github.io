...
<head>
  ...
  <!-- creator zCreator-->
    ...
    <link rel="author" type="text/plain" href="zCreator/humans.txt">
	  <link rel="sitemap" type="application/xml" title="Sitemap" href="zCreator/sitemap.xml"/>
 <!-- Favicons -->
...
echo "<center><h1><font color='red'>Para esta Pagina, se requiere Auorizaci&oacute;n ...</font></h1></center>";
echo "<center>---->".[error_reporting()]."</center>";
echo "<center><h1><font color='#596E6E'>Petromarina News</font></h1></center>";
echo "<center><hr></center>";
echo "<center><h2><font color='#596E6E'>Tel.54-2262-361174 </font></h2></center>";
echo "<center><hr></center>";
...
<footer>
	<center>
		 ...
		 <p class="propaganda">SITIO WEB COMPATIBLE CON IPHONE & IPAD · FIREFOX · INTERNET EXPLORER 7/8/9 · CHROME · SAFARI · OPERA <br />
		 Copyright © 2020  - www.petromarina.net - Todos los Derechos Reservados.</p>
	    <p class="propaganda">Site Responsive Desing - Powered by Daniel Valdez.</p>
    </center>  
