<?php
     if(session_id()=="")
   {
	...
	function enviarEmail($email, $nombre, $asunto, $cuerpo){
		...
		$mail->Username = 'danielkvaldez2@gmail.com'; //Modificar
		$mail->Password = '1205*Sandra'; //Modificar
		
		$mail->setFrom('danielkvaldez2@gmail.com', 'kvalhost Sistemas Informaticos'); //Modificar
