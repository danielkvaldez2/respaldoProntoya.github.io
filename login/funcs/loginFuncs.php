...
// eeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeste ec comment **************************

	function registraComentario($usuario, $pass_hash, $nombre, $email, $activo, $token, $tipo_usuario){
...
function enviarEmail($email, $nombre, $asunto, $cuerpo){
	...
	$mail->SMTPSecure = 'tls'; 
	$mail->SMTPAuth = true; 
	$mail->Username = 'portspetromarinainc@gmail.com'; 
	$mail->Password = '1205diego';  
	$mail->setFrom('portspetromarinainc@gmail.com','Petromarina News'); 
		...
		if($rows > 0) {
			...
			if(isActivo($usuario)){
				...
				if($validaPassw){
					...
					header("location: ../login/0noticiasSistem/welcome.php");
					} else {
