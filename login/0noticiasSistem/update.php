<?php
 ...
 //echo $_POST['texto'];
  ...
  if ($archivo1 <> "") {
     $sql = "UPDATE personas SET dia='$dia', mes='$mes', posted='$posted', titulo='$titulo', texto='$texto', archivo='$archivo1' WHERE id = '$id'";
  } else {
     $sql = "UPDATE personas SET dia='$dia', mes='$mes', posted='$posted', titulo='$titulo', texto='$texto'  WHERE id = '$id'" ;
  }
