...
if ($archivo1 <> "") {
    ...
    $sql = "UPDATE databaseship SET nameS='$name',flag='$flag',country='$country',imo='$imo',mmsi='$mmsi',callsign='$callsign',size='$size',draught='$draught',yearS='$year' ,typeship='$typeship',maker='$maker',imagen='$archivo1',userModif='$userModif' WHERE id= '$id'";

} else {

	$sql = "UPDATE databaseship SET nameS='$name',flag='$flag',country='$country',imo='$imo',mmsi='$mmsi',callsign='$callsign',size='$size',draught='$draught',yearS='$year' ,typeship='$typeship',maker='$maker', userModif='$userModif' WHERE id= '$id'";
