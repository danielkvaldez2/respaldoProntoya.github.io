...
// var_dump($_FILES);
  ...
  $sql = "UPDATE tbl_productos SET strProdNombProducto='$strProdNombProducto',strProdMarca='$strProdMarca',strProdVolumen='$strProdVolumen',strProdDescripcion='$strProdDescripcion',floatProdPrecio='$floatProdPrecio',strProdCodigo='$strProdCodigo',strProdImagen='$archivo1',strProdImagenThumb='$archivo1',id_categProd='$id_categProd',id_subcategProd='$id_subcategProd',strOferta='$strOferta',userModif='$userModif' WHERE id_producto = '$id'";

} else {

	$sql = "UPDATE tbl_productos SET strProdNombProducto='$strProdNombProducto',strProdMarca='$strProdMarca',strProdVolumen='$strProdVolumen',strProdDescripcion='$strProdDescripcion',floatProdPrecio='$floatProdPrecio',strProdCodigo='$strProdCodigo',id_categProd='$id_categProd',id_subcategProd='$id_subcategProd',strOferta='$strOferta',userModif='$userModif' WHERE id_producto = '$id'";
